...
class Spaceship(Sprite):
    ...
    def __init__(self):
        ...
        self.image = pygame.transform.scale(self.image, (self.SPACESHIP_WIDTH, self.SPACESHIP_WEIGTH))
    ...
    def update(self, user_input):
        ...
        elif user_input[pygame.K_RIGHT] and self.rect.x < SCREEN_WIDTH:
            self.rect.x += 10
    ...
    def draw(self, screen):
        screen.blit(self.image, self.rect (200, 500))